  ...
  return (
    <div className="eventssection">
      ...
      <div className="ourevents">
        ...
        <div className="event">
          <p className="eventicon">< GrAppsRounded/></p>
          <p className="eventdesc">UI/UX Design</p>
          <h3 className="eventtitle"><FaRegCalendarAlt/> Tuesday 5pm to 8pm</h3>
          <h3 className="eventtitle"> Computer Lab F04</h3>
          
          <p className="lead">Lead: Manase Gunga</p>
        </div>
        <div className="event">
          <p className="eventicon">< CgWebsite/></p>
          <p className="eventdesc">Web Development</p>
          <h3 className="eventtitle"><FaRegCalendarAlt/> Wednesday 6pm to 9pm</h3>
          <h3 className="eventtitle"> Computer Lab F04</h3>
        ...
        <div className="event">
          ...
          <h3 className="eventtitle"><FaRegCalendarAlt/> Thursday 4pm to 7pm</h3>
          <h3 className="eventtitle"> Computer Lab F04</h3>
          <p className="lead">Lead: Stanely Amunze</p>
        </div>
        <div className="event">
          <p className="eventicon">< GrCloudComputer/></p>
          <p className="eventdesc"> Cloud Engineering</p>
          <h3 className="eventtitle"><FaRegCalendarAlt/> Friday 3pm to 6pm</h3>
          <h3 className="eventtitle"> Computer Lab F04</h3>
          <p className="lead">Lead: Paul Karanja</p>
        </div>
        <div className="event">
          <p className="eventicon">< FaAws /></p>
          <p className="eventdesc">Cloud Engineering</p>
          <h3 className="eventtitle"><FaRegCalendarAlt/> Saturday 1pm to 4pm</h3>
          <h3 className="eventtitle"> Computer Lab F04</h3>
