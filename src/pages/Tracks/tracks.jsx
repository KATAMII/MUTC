          ...
          <div className="Tracks-description">
            ...
            <div className="tracRight">
              ...
              <div className="tracPara">
                ...
                <p className="para">
                  {" "}
                  You will have a chance to engage in hands on projects and real
                  world scenario.
                </p>
              </div>
            </div>
          ...
          <div className="Tracks-description">
            ...
            <div className="tracRight">
              ...
              <div className="tracPara">
                ...
                <p className="para">
                  {" "}
                  You will gain proficiency in using industrial desing tools.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="Tracks-description">
            ...
            <div className="tracRight">
              ...
              <div className="tracPara">
                ...
                <p className="para">
                  {" "}
                  You will gain capability to develop a full-stack web App and
                  scalable webs.
                </p>
              </div>
            </div>
          ...
          <div className="Tracks-description">
            ...
            <div className="tracRight">
              ...
              <div className="tracPara">
                ...
                <p className="para">
                  {" "}
                  You will be able to test and deploy mobile apps ready to
          ...
          <div className="Tracks-description">
            ...
            <div className="tracRight">
              ...
              <div className="tracPara">
                ...
                <p className="para">
                  {" "}
                  You will be able to understand how to design ,deploy and
                  manage secure cloud infrastracture..
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="Tracks-description">
            ...
            <div className="tracRight">
              ...
              <div className="tracPara">
                ...
                <p className="para">
                  {" "}
                  You will be proficient in developing integrated solutions
                  using the power platforms. .
                </p>
              </div>
            </div>
          </div>
